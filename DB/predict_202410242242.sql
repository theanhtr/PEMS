...
-- Script date 10/30/2024 8:52:11 PM
...
--
CREATE PROCEDURE Proc_Predict_Filter (IN v_ProvinceId varchar(255), IN v_DistrictId varchar(255), IN v_WardId varchar(255), IN v_StartDate datetime, IN v_EndDate datetime, IN v_CropStageId char(36), IN v_PestStageId char(36), IN v_SeasonEnd tinyint(1), IN v_PageSize int, IN v_PageNumber int)
SQL SECURITY INVOKER
