namespace Base.Model
{
    ...
    public class BaseFilterResponse<TEntity>
    {
        #region Properties
        /// <summary>
        /// Tổng số trang
        ...
        #region Constructor
        public BaseFilterResponse(int? totalPage, int? totalRecord, int? currentPage, int? currentPageRecords, List<TEntity>? data)
        {
            TotalPage = totalPage;
